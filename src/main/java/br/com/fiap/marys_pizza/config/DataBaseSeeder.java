    ...
    public class DataBaseSeeder implements CommandLineRunner {
        ...
        public void run(String... args) throws Exception {
            ...
            clienteRepository.saveAll(List.of(
                new Cliente(1L,"Vitorio Graton","","vitorio@graton.com.br","(11) 94970-0003","S3nh@c0mpl3x@","Usuario123_xyz",LocalDate.of(2004, Month.FEBRUARY, 4),null,null,null,null),
                new Cliente(2L,"Matheus Montemurro","","montemurro.matheus@gmail.com","(11) 99877-6673","S3nh@c0mpl3x@","Usuario1_xyz",LocalDate.of(1998, Month.SEPTEMBER, 19),null,null,null,null)
            ));
        }
